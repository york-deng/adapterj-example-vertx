...
public class SimpleVerticle extends InitVerticle {

  private static final boolean DEBUG = Debugger.DEBUG;
  private static final String TAG = SimpleVerticle.class.getName();
  ...
  public SimpleVerticle() {
    try {
      final String dir = SimpleVerticle.class.getClassLoader().getResource("").getPath();
      if (DEBUG) {
